...
export class CellComponent implements OnInit {
  ...
  @HostListener('click') onClick() {
    if (this.cellValue === ' ') {
      this.cellValue = this.playerTurnService.getNextTurn().symbol;
      this.gameBoardService.updatPosition(
        this.r,
        this.c,
        this.cellValue
      );
      ...
      console.log(' Game status ' + this.gameBoardService.getGameStatus())
    }
  }
